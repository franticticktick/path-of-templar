...
public class UserCamera : MonoBehaviour
{
    ...
    [SerializeField]
    private HeroComponent bgunaAglo;
    ...
    public void OnArmorWorn(Armor armor)
    {
        switch (armor)
        {
            case GrizaKorvoArmor grizaKorvoArmor:
                target = grizaKorvo.transform;
                userModel = grizaKorvo.gameObject;
                break;
            case BrunaAgloArmor brunaAgloArmor:
                target = bgunaAglo.transform;
                userModel = bgunaAglo.gameObject;
                break;
        }
    }
    ...
    {
        target = defaultHero.transform;
        userModel = defaultHero.gameObject;
    }
}
